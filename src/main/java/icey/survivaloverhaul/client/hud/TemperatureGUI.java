...
import icey.survivaloverhaul.common.util.MathUtil;
...
public class TemperatureGUI {
    ...
    public static void renderGUI(MatrixStack matrix, PlayerEntity player, int width, int height) {
        ...
        if (Config.Baked.temperatureDisplayMode == TemperatureDisplayEnum.SYMBOL)
        {
    ...
    public static void drawTemperatureAsSymbol(MatrixStack matrix, TemperatureCapability cap, int width, int height) {
        ...
        RenderUtil.drawTexturedModalRect(m4f, x + xOffset, y + yOffset, temperatureTextureWidth * icon.getIconIndex(), temperatureTexturePosY, temperatureTextureWidth, temperatureTextureHeight);
        RenderUtil.drawTexturedModalRect(m4f, x + xOffset, y + yOffset, temperatureTextureWidth * icon.getIconHolder(), temperatureTexturePosY, temperatureTextureWidth, temperatureTextureHeight);
        ...
        RenderUtil.drawTexturedModalRect(m4f, x + xOffset, y + yOffset, ovrXOffset, ovrYOffset, temperatureTextureWidth, temperatureTextureHeight);
    }
    ...
    public static void drawWetness(MatrixStack matrix, WetnessCapability cap, int width, int height) {
        ...
        RenderUtil.drawTexturedModalRect(m4f, x + xOffset, y + yOffset, texPosX, texPosY, wetnessTextureWidth, wetnessTextureHeight);
