...
public class JsonConfigRegistration {
    ...
    public static void init(File configDir) {
        ...
        registerTemperatureConsumables(configDir);

        registerThirstConsumables(configDir);
    ...
    private static void registerThirstConsumables(File configDir) {
    }
    ...
    private static void registerTemperatureConsumables(File configDir) {
